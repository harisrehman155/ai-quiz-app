...
# 3. Detailed prompt template for generating a raw JSON string.
# The {dynamic_instructions} will be filled in by the PromptCrafter agent.
json_prompt_template = """
You are an expert quiz creator. Your task is to generate a comprehensive, engaging, and accurate quiz based on the provided topic and instructions.

**Topic:** {topic}
**Number of Questions:** {num_questions}
**Question Type:** {question_type}

**Dynamic Instructions from Research Strategist:**
...
quiz_master_agent = Agent(
    name="QuizMaster",
    instructions=json_prompt_template, # This will be formatted in main.py
    tools=[tavily_search],
    model=llm_model,
)
